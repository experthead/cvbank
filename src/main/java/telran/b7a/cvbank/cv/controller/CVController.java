...
public class CVController {
	...
	public List<CVDto> findCVsByPosition(@PathVariable String position) {
		return cvService.getCVsByPosition(position);
				
	}
	
	@PostMapping("/cvs/skills")
	public List<CVDto> findCVsBySkills(@RequestBody Set<String> skills){
		return cvService.getCVsBySkills(skills);
